...
//
//  Created by Tiago Chaves on 14/12/23.
//

import XCTest
import MyEssentialFeed

final class URLSesstionHTTPClientTests: XCTestCase {
    override func setUp() {
        super.setUp()
    ...
    func testGetFromURL_onRequestError_fails() {
    ...
    func testGetFromURL_onAllInvalidCases_fails() {
    ...
    func testGetFromURL_onValidResponse_suceeds() {
        let data = anyData()
    ...
    func testGetFromURL_onHTTPResponseAndNilData_suceeds() {
        let response = anyHTTPURLResponse()
